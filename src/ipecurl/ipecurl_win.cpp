...
int main(int argc, char * argv[]) {
    ...
    HINTERNET hSession = WinHttpOpen(agent, WINHTTP_ACCESS_TYPE_DEFAULT_PROXY,
    ...
    BOOL bResults = WinHttpSendRequest(hRequest, wAdditionalHeaders.data(), -1,
				       (LPVOID)mime.data(), mime.size(), mime.size(), 0);
