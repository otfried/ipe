...
- (void) mouseDown:(NSEvent *) event
{
  ...
  if ([obj respondsToSelector:@selector(pdfViewMouseButton:atLocation:)]) {
    ...
    NSArray<NSNumber *> *qq = @[ [NSNumber numberWithDouble:q.x], [NSNumber numberWithDouble:q.y] ];
    [obj performSelector:@selector(pdfViewMouseButton:atLocation:) withObject:event withObject:qq];
  }
}
