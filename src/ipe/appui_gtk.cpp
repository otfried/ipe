...
AppUi::AppUi(lua_State * L0, int model)
    ...
    GtkBox * sb = GTK_BOX(gtk_statusbar_get_message_area(GTK_STATUSBAR(iStatusBar)));
...
bool AppUi::actionState(const char * name) {
    ...
    return (idx >= 0) ? gtk_check_menu_item_get_active(
...
void AppUi::closeWindow() { delete this; }
